#!/usr/bin/env python3
"""Validate Phase 2 internal patent-review evidence pack artifact for patent-workflow.
...
Usage:
  python validate_evidence_pack.py artifacts/prior_art/phase_02_evidence_pack.json
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Validate phase_02 evidence_pack.json structure")
    ap.add_argument("input", help="Path to phase_02_evidence_pack.json")
    ...
    _require(phase in {"phase_02", "phase_04"}, "phase must be 'phase_02'", errors)
