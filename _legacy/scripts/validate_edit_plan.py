...
Usage:
  python validate_edit_plan.py artifacts/revision/phase_08_edit_plan.json
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Validate phase_08_edit_plan.json structure")
    ap.add_argument("input", help="Path to phase_08_edit_plan.json")
